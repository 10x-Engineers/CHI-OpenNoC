...
> **One RN-F per HN-F today.** The HN-F elects Forwarding snoops toward RN-Fs that
> declare no `Direct_Cache_Transfer`
> ([#283](https://github.com/10x-Engineers/CHI-OpenNoC/issues/283)). It is
