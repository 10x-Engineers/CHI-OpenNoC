...
generate if(FIFO_ENTRIES_DEPTH == 1)begin
            ...
            localparam [31:0]               DEPTH_M1 = FIFO_ENTRIES_DEPTH-1;
            localparam [FIFO_PTR_WIDTH-1:0] PTR_LAST = DEPTH_M1[FIFO_PTR_WIDTH-1:0];
            localparam [FIFO_PTR_WIDTH:0]   CNT_LAST = DEPTH_M1[FIFO_PTR_WIDTH:0];
            ...
            assign rd_ptr_ns = (rd_ptr == PTR_LAST)? {FIFO_PTR_WIDTH{1'b0}} : (rd_ptr[FIFO_PTR_WIDTH-1:0] + 1'b1);
            ...
            assign wr_ptr_ns = (wr_ptr == PTR_LAST)? {FIFO_PTR_WIDTH{1'b0}} : (wr_ptr[FIFO_PTR_WIDTH-1:0] + 1'b1);
            ...
            // fifo full logic
            assign full_ns = (count == CNT_LAST) & ~pop;
