...
module rni_datbuf_bank `RNI_PARAM
    ...
    always_comb begin
        ...
        for (int i =0; i<RNI_AR_ENTRIES_NUM_PARAM; i=i+1) begin
            if(bank0_rd_en_i && (bank0_rd_addr_i == i[`RNI_RD_BANK_ADDR_WIDTH-1:0]))
    ...
    always_comb begin
        ...
        for (int i =0; i<RNI_AR_ENTRIES_NUM_PARAM; i=i+1) begin
            if(bank1_rd_en_i && (bank1_rd_addr_i == i[`RNI_RD_BANK_ADDR_WIDTH-1:0]))
    ...
    always_comb begin
        ...
        for (int i =0; i<RNI_AR_ENTRIES_NUM_PARAM; i=i+1) begin
            if(bank2_rd_en_i && (bank2_rd_addr_i == i[`RNI_RD_BANK_ADDR_WIDTH-1:0]))
    ...
    always_comb begin
        ...
        for (int i =0; i<RNI_AR_ENTRIES_NUM_PARAM; i=i+1) begin
            if(bank3_rd_en_i && (bank3_rd_addr_i == i[`RNI_RD_BANK_ADDR_WIDTH-1:0]))
