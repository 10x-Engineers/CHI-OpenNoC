...
module hni_global_monitor `HNI_PARAM 
    ...
    logic [`CHIE_REQ_FLIT_SRCID_WIDTH-1:0]  gb_srcid_q[0:HNI_MSHR_EXCL_RN_NUM_PARAM-1];
    logic [`CHIE_REQ_FLIT_LPID_WIDTH-1:0]   gb_lpid_q[0:HNI_MSHR_EXCL_RN_NUM_PARAM-1];
    logic [`CHIE_REQ_FLIT_ADDR_WIDTH-1:0]   gb_addr_q[0:HNI_MSHR_EXCL_RN_NUM_PARAM-1];

    logic                                   gb_valid_w[0:HNI_MSHR_EXCL_RN_NUM_PARAM-1];
    logic [`CHIE_REQ_FLIT_SRCID_WIDTH-1:0]  gb_srcid_w[0:HNI_MSHR_EXCL_RN_NUM_PARAM-1];
    logic [`CHIE_REQ_FLIT_LPID_WIDTH-1:0]   gb_lpid_w[0:HNI_MSHR_EXCL_RN_NUM_PARAM-1];
    logic [`CHIE_REQ_FLIT_ADDR_WIDTH-1:0]   gb_addr_w[0:HNI_MSHR_EXCL_RN_NUM_PARAM-1];
