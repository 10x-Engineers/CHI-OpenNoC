...
`endif
    ...
    input  wire [`CACHE_TAGV_WIDTH-1:0]              dbf_l3_wr_tagv_q,
    ...
    output wire [`CACHE_TAGV_WIDTH-1:0]              l3_wr_tagv_q,
    ...
    localparam [31:0] LOC_CNT_LAST = {{(32-`LOC_INDEX_WIDTH){1'b0}}, {`LOC_INDEX_WIDTH{1'b1}}};

    logic [31:0]                sf_cnt_reg;
    logic [ 1:0]                sf_done_reg;
    logic [31:0]                loc_cnt_reg;
    logic [ 1:0]                loc_done_reg;
    logic [31:0]                lru_cnt_reg;
    logic [ 1:0]                lru_done_reg;
    ...
    always_ff @(posedge clk or posedge rst) begin
        ...
        else if (sf_cnt_reg == SF_CNT_LAST) begin
        end
        else begin
    ...
    always_ff @(posedge clk or posedge rst) begin
        ...
        else if (loc_cnt_reg == LOC_CNT_LAST) begin
        end
        else begin
    ...
    always_ff @(posedge clk or posedge rst) begin
        ...
        else if (lru_cnt_reg == LOC_CNT_LAST) begin
        end
        else begin
...
`ifdef tb_hnf
    ...
    assign l3_wr_tagv_q      = dbg_l3_valid_q? '0                : dbf_l3_wr_tagv_q;
...
`else
    ...
    assign l3_wr_tagv_q   = dbf_l3_wr_tagv_q;
