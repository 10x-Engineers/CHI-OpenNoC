...
`endif
    ...
    chie_pkg::req_rsvdc_t                    mshr_txreq_bypass_rsvdc_s1;
    ...
    wire [5:0]                               mshr_txsnp_stash_lpid_sx1;
    ...
    wire                                     li_mshr_rxreq_stashnidvalid_s0;
    wire [4:0]                               li_mshr_rxreq_stashlpid_s0;
    ...
    chie_pkg::req_rsvdc_t                    li_mshr_rxreq_rsvdc_s0;
    ...
    wire [1:0]                               li_dbf_rxdat_tagop_s0;
    wire [chie_pkg::TAG_WIDTH-1:0]           li_dbf_rxdat_tag_s0;
    wire [chie_pkg::TU_WIDTH-1:0]            li_dbf_rxdat_tu_s0;
    ...
    wire [HNF_MSHR_RNF_NUM_PARAM-1:0]        l3_stash_bit_sx7_q;
    ...
    wire                                     mshr_dbf_atm_set_s0;
    wire [`MSHR_ENTRIES_WIDTH-1:0]           mshr_dbf_atm_idx_s0;
    chie_pkg::req_opcode_e                   mshr_dbf_atm_op_s0;
    wire [5:0]                               mshr_dbf_atm_off_s0;
    ...
    wire                                     mshr_l3_snoopme_sx1_q;
    wire [chie_pkg::NID_WIDTH-1:0]           mshr_l3_stash_nid_sx1_q;
    wire                                     mshr_l3_stash_v_sx1_q;
    ...
    opennoc_hnf_pkg::hnf_tagv_s              l3_rd_tagv_q;
    ...
    wire [`CACHE_TAGV_WIDTH-1:0]             dbf_l3_wr_tagv_q;
    ...
    hnf_link `HNF_PARAM_INST
             u_hnf_link(
                 ...
                 .mshr_txsnp_stash_lpid_sx1                    (mshr_txsnp_stash_lpid_sx1         ),
                 ...
                 .li_mshr_rxreq_stashnidvalid_s0               (li_mshr_rxreq_stashnidvalid_s0    ),
                 .li_mshr_rxreq_stashlpid_s0                   (li_mshr_rxreq_stashlpid_s0        ),
                 ...
                 .li_dbf_rxdat_tagop_s0                        (li_dbf_rxdat_tagop_s0             ),
                 .li_dbf_rxdat_tag_s0                          (li_dbf_rxdat_tag_s0               ),
                 .li_dbf_rxdat_tu_s0                           (li_dbf_rxdat_tu_s0                ),
    ...
    hnf_mshr `HNF_PARAM_INST
             u_hnf_mshr(
                 ...
                 .l3_stash_bit_sx7_q                           (l3_stash_bit_sx7_q                ),
    ...
    hnf_data_buffer `HNF_PARAM_INST
                    u_hnf_data_buffer(
                        ...
                        .pipe_dbf_wr_tagv_sx9_q                       (l3_rd_tagv_q                      ),
                        ...
                        .dbf_pipe_rd_tagv_sx7_q                       (dbf_l3_wr_tagv_q                  ),
                        .dbf_txdat_valid_sx1                          (dbf_txdat_valid_sx1               ),
                        .dbf_txdat_idx_sx1                            (dbf_txdat_idx_sx1                 ),
                        .dbf_txdat_be_sx1                             (dbf_txdat_be_sx1                  ),
                        .dbf_txdat_pe_sx1                             (dbf_txdat_pe_sx1                  ),
    ...
    // SS16.2.6 (p.16-476): BROADCASTMTE is asserted -- this Home carries MTE to its Subordinate.
    assign l3_tags_full_sx7_q  = opennoc_hnf_pkg::hnf_tagv_full(l3_rd_tagv_q);
    assign l3_tags_dirty_sx7_q = l3_rd_tagv_q.dirty;
...
`endif
                    ...
                    .dbf_l3_wr_tagv_q                             (dbf_l3_wr_tagv_q                  ),
    ...
    if (HNF_MSHR_ENTRIES_WIDTH_PARAM != ((HNF_MSHR_ENTRIES_NUM_PARAM > 1) ? $clog2(HNF_MSHR_ENTRIES_NUM_PARAM) : 1))
        $fatal(1, "hnf: HNF_MSHR_ENTRIES_WIDTH_PARAM=%0d cannot index HNF_MSHR_ENTRIES_NUM_PARAM=%0d entries; the width is $clog2 of the count, so leave it at its default.",
               HNF_MSHR_ENTRIES_WIDTH_PARAM, HNF_MSHR_ENTRIES_NUM_PARAM);
    if (HNF_MSHR_EXCL_RN_WIDTH_PARAM != ((HNF_MSHR_EXCL_RN_NUM_PARAM > 1) ? $clog2(HNF_MSHR_EXCL_RN_NUM_PARAM) : 1))
        $fatal(1, "hnf: HNF_MSHR_EXCL_RN_WIDTH_PARAM=%0d cannot index HNF_MSHR_EXCL_RN_NUM_PARAM=%0d monitors; the width is $clog2 of the count, so leave it at its default.",
               HNF_MSHR_EXCL_RN_WIDTH_PARAM, HNF_MSHR_EXCL_RN_NUM_PARAM);
