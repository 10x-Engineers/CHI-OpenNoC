...
module hnf_link_rxdat_parse `HNF_PARAM
    ...
    assign rxdat_lcrdv = rxdatcrdv_s1_q & rxcrd_en;
    //-----------------------------------------------------------------------------
    // DISPLAY INFO
    //-----------------------------------------------------------------------------
`ifdef DISPLAY_INFO
