...
module hnf_mshr `HNF_PARAM
    ...
    input  wire [chie_pkg::REQ_ADDR_WIDTH-1:0] pipe_mshr_addr_sx2_q,
    input  wire                                pipe_mshr_addr_valid_sx2_q,
    input  wire [`MSHR_ENTRIES_WIDTH-1:0]      pipe_mshr_addr_idx_sx2_q,
    input  wire [chie_pkg::REQ_ADDR_WIDTH-1:`CACHE_BLOCK_OFFSET] pipe_evict_cam_addr_sx4,
    input  wire                                pipe_evict_cam_valid_sx4,
    input  wire [`MSHR_ENTRIES_WIDTH-1:0]      pipe_evict_cam_idx_sx4,
    output wire                                mshr_evict_hazard_sx5,
    ...
    output wire [chie_pkg::SNP_ADDR_WIDTH-1:0] mshr_txsnp_addr_sx1,
    output wire [chie_pkg::REQ_ADDR_WIDTH-1:0] mshr_txreq_addr_sx1,
    output wire                                mshr_l3_hazard_valid_sx3_q,
    output wire [chie_pkg::REQ_ADDR_WIDTH-1:0] mshr_l3_addr_sx1,
    ...
    output wire [1:0]                             mshr_dbf_rd_pe_sx1,
    ...
    output wire [11:0]                         mshr_txreq_txnid_sx1_q,
    ...
    output wire [11:0]                         mshr_txrsp_txnid_sx1_q,
    ...
    output wire [11:0]                         mshr_txsnp_txnid_sx1_q,
    ...
    output wire [chie_pkg::NID_WIDTH-1:0]      mshr_txdat_tgtid_sx2,
    output wire [11:0]                         mshr_txdat_txnid_sx2,
    ...
    output wire [11:0]                         mshr_txdat_dbid_sx2,
    output wire [1:0]                          mshr_txdat_ccid_sx2,
    output wire                                mshr_txdat_tracetag_sx2,
    ...
    hnf_mshr_ctl `HNF_PARAM_INST
                 u_hnf_mshr_ctl(
                     ...
                     .mshr_snp_outstanding_sx                         (mshr_snp_outstanding_sx           ),
