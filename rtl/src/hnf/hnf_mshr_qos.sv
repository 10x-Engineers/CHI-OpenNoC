...
module hnf_mshr_qos `HNF_PARAM
    ...
    assign li_req_static_alloc_s0   = li_req_static_s0 & !(li_mshr_rxreq_opcode_s0 == chie_pkg::REQ_SNOOPFILTEREVICT);
    ...
    always_ff @(posedge clk or posedge rst) begin: mshr_entry_idx_alloc_timing_logic
        if (rst == 1'b1)
            mshr_entry_idx_alloc_s1_q <= {`MSHR_ENTRIES_WIDTH{1'b0}};
        else
    ...
    always_ff @(posedge clk or posedge rst) begin:update_retry_enable_timing_logic
        if (rst == 1'b1)
    ...
    always_ff @(posedge clk or posedge rst) begin:update_mshr_qos_pool_timing_logic
        if (rst == 1'b1)
    ...
    always_ff @(posedge clk or posedge rst) begin: update_mshr_dyn_or_seq_alloc_timing_logic
        if (rst == 1'b1)
    ...
    generate
        for(entry=0;entry<`MSHR_ENTRIES_NUM;entry=entry+1)begin
            always_ff @(posedge clk) begin: update_mshr_pool_timing_logic
    ...
    always_ff @(posedge clk or posedge rst) begin:update_hhigh_pool_full_timing_logic
        if (rst == 1'b1)
    ...
    assign qos_pool_med_full_s0 = (qos_pool_med_cnt_ns == QOS_MED_POOL_FULL);

    always_ff @(posedge clk or posedge rst) begin: update_med_pool_count_timing_logic
        if (rst == 1'b1)
    ...
    always_ff @(posedge clk or posedge rst) begin: update_med_pool_full_timing_logic
        if (rst == 1'b1)
    ...
    always_ff @(posedge clk or posedge rst) begin: update_seq_pool_count_timing_logic
        if (rst == 1'b1)
    ...
    always_ff @(posedge clk or posedge rst) begin: update_retry_bank_cnt_ptr_timing_logic
        if (rst == 1'b1)
    ...
    //update hhigh class
    always_ff @(posedge clk or posedge rst) begin: update_hhigh_class_timing_logic
        if (rst == 1'b1)
            qpc_hhigh_s1_q <= 1'b0;
        else if (li_mshr_rxreq_valid_s0 == 1'b1)
    ...
    //update high class
    always_ff @(posedge clk or posedge rst) begin: update_high_class_timing_logic
        if (rst == 1'b1)
            qpc_high_s1_q <= 1'b0;
        else if (li_mshr_rxreq_valid_s0 == 1'b1)
    ...
    //update med class
    always_ff @(posedge clk or posedge rst) begin: update_med_class_timing_logic
        if (rst == 1'b1)
            qpc_med_s1_q <= 1'b0;
        else if (li_mshr_rxreq_valid_s0 == 1'b1)
    ...
    //update low class
    always_ff @(posedge clk or posedge rst) begin: update_low_class_timing_logic
        if (rst == 1'b1)
            qpc_low_s1_q <= 1'b0;
        else if (li_mshr_rxreq_valid_s0 == 1'b1)
    ...
    generate
        for(ret_entry=0;ret_entry<`RET_BANK_ENTRIES_NUM;ret_entry=ret_entry+1)begin
            ...
            always_ff @(posedge clk or posedge rst) begin: update_hh_entry_cnt_timing_logic
                if (rst == 1'b1)
            ...
            always_ff @(posedge clk or posedge rst) begin: update_m_entry_cnt_timing_logic
                if (rst == 1'b1)
    ...
    always_ff @(posedge clk or posedge rst) begin: update_hh_present_win_timing_logic
        if (rst == 1'b1)
    ...
    always_ff @(posedge clk or posedge rst) begin: update_m_present_win_timing_logic
        if (rst == 1'b1)
    ...
    always_ff @(posedge clk or posedge rst) begin: update_high_to_hhigh_timing_logic
        if (rst == 1'b1)
    ...
    always_ff @(posedge clk or posedge rst) begin: update_med_to_hhigh_timing_logic
        if (rst == 1'b1)
    ...
    always_ff @(posedge clk or posedge rst) begin: update_pcrdgrant_enable_timing_logic
        if (rst == 1'b1)
    ...
    always_ff @(posedge clk or posedge rst) begin: update_hhigh_cnt_dec_ptr_timing_logic
        if (rst == 1'b1)
    ...
    always_ff @(posedge clk or posedge rst) begin: update_high_cnt_dec_ptr_timing_logic
        if (rst == 1'b1)
    ...
    always_ff @(posedge clk or posedge rst) begin: update_med_cnt_dec_ptr_timing_logic
        if (rst == 1'b1)
    ...
    always_ff @(posedge clk or posedge rst) begin: update_low_cnt_dec_ptr_timing_logic
        if (rst == 1'b1)
