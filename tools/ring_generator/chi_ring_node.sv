...
`ifdef DISPLAY_FATAL
  ...
  initial if ((REQ_FLIT_WIDTH == 0) || (RSP_FLIT_WIDTH == 0) || (DAT_FLIT_WIDTH == 0) || (SNP_FLIT_WIDTH == 0) || (SNP_TGTID_OFFSET == 0) || (ROUTER_NODE_NUM == 0))
    $fatal(1, "chi_ring_node: the flit widths, SNP_TGTID_OFFSET and ROUTER_NODE_NUM must be overridden");
